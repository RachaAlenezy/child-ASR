...
# set up file paths
# train_audio_path = 'filtered/s/'
train_pict_path = 'picts/train/'
# train_map_csv = '../data/train_map.csv'
# test_pict_path = 'picts/test/'
...
def wav2img(wav_path, targetdir='', figsize=(10, 10)):
    """
    ...
    _, spectrogram = log_specgram(test_sound, samplerate)
    # create output path
    output_file = wav_path.split("/")[2].split('.wav')[0]
...
for i, p in enumerate(wavs):
    print("p:", p)
    targetdir = train_pict_path
    pict_path = wav2img(p, targetdir=targetdir)
